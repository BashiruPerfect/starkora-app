    ...
    pages: {
        ...
        content: [
          ...
          },
          {
            ...
            props: {
              ...
              heading: `${cleanName}`,
              subheading: description || `Providing premier ${cleanType} solutions across ${cleanLoc} with verified quality, prompt delivery, and complete customer satisfaction.`,
          ...
          },
          {
            ...
            props: {
              ...
              features: [
                { title: "Verified Craftsmanship", description: `Uncompromising quality standards across every ${cleanType} engagement.` },
                { title: "Punctual Delivery", description: `Prompt turnaround tailored to our clients in ${cleanLoc}.` },
                { title: "Direct Communication", description: "Seamless WhatsApp and phone availability with zero hidden charges." }
              ]
            }
          },
          {
          ...
          {
            type: "FooterBlock",
            props: { id: "footer-home", copyrightText: `© ${new Date().getFullYear()} ${cleanName}. Powered by STARKORA.` }
          }
        ],
      ...
      about: {
        content: [
          ...
          },
          {
            ...
            props: {
              ...
              features: [
                ...
                { title: "Client Success", description: "Our success is defined exclusively by the satisfaction and growth of our clientele." },
          ...
          {
            type: "FooterBlock",
            props: { id: "footer-about", copyrightText: `© ${new Date().getFullYear()} ${cleanName}. Powered by STARKORA.` }
          }
        ],
        ...
        content: [
          ...
          },
          {
            ...
            props: {
              id: "hero-services",
              badgeText: "SOLUTIONS",
              heading: "Tailored Packages & Services",
          ...
          {
            type: "FooterBlock",
            props: { id: "footer-services", copyrightText: `© ${new Date().getFullYear()} ${cleanName}. Powered by STARKORA.` }
          }
        ],
      ...
      contact: {
        content: [
          ...
          {
            type: "FooterBlock",
            props: { id: "footer-contact", copyrightText: `© ${new Date().getFullYear()} ${cleanName}. Powered by STARKORA.` }
          }
        ],
...
4. Write tailored copy for "${cleanName}". Never output generic placeholder text.
  ...
  "pages": {
    "home": {
      "content": [
        ...
        { "type": "ContactWhatsAppBlock", "props": { "id": "contact-1", "title": "Contact Us", "subtitle": "...", "phoneNumber": "+2348012345678", "whatsappMessage": "Hello!", "email": "contact@business.com", "location": "${location || "Nigeria"}" } },
    ...
    "contact": {
      "content": [
        ...
        { "type": "ContactWhatsAppBlock", "props": { "id": "contact-main", "title": "Direct Communication", "subtitle": "...", "phoneNumber": "+2348012345678", "whatsappMessage": "Hello ${cleanName}!", "email": "contact@business.com", "location": "${location || "Nigeria"}" } },
...
`;
        ...
        // Resolve wrapper variations (e.g. if AI wrapped output in "website" or "site")
